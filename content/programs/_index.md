...
- Image modification: [ImageMagick](https://imagemagick.org), [GIMP](https://www.gimp.org)
- Operating System: [Arch Linux](https://archlinux.org)
- Download + torrent utility: [aria2](https://aria2.github.io)
- Mail client/RSS reader: [Betterbird](https://www.betterbird.eu), [geary](https://wiki.gnome.org/Apps/Geary)
...
- Web browser: [librewolf](https://librewolf.net), [Brave](https://brave.com) ([Checkout browsers comparison here](/programs/browsers))
